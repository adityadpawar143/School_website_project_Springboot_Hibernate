...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4 class="card-title">New Board</h4>
                              </div>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="exampleInputEmail1" name="" aria-describedby="emailHelp" placeholder="Board ID" required>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Board Name*</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="board_name" placeholder="Board Name" required>
  </div><br>
