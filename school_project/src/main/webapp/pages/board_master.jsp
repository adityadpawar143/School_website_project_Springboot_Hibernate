                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-sm-0 p-md-0 justify-content-sm-end"><a href="add_board_master"  class="btn btn-primary" style="color:white;">+ Add new Board</a></div>
                            </div>
                 ...
                 <c:forEach var="board" items="${b}"> 
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="editboard?id=${board.board_id}" style="color:white;" class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                <a href="deleteboard?id=${board.board_id}" class="btn btn-danger">Delete</a>
                                                </td>
