...
<body>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Board</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="exampleInputEmail1" value="${BB.board_id}" name="board_id" aria-describedby="emailHelp" placeholder="Board ID" required>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Board Name*</label>
    <input type="text" class="form-control" id="exampleInputPassword1" value="${BB.board_name}" name="board_name" placeholder="Board Name" required>
  </div><br>

  <input type="submit" class="btn btn-primary" value="Update">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="board_master"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
