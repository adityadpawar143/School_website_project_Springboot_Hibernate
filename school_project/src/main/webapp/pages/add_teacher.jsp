...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="teacher_fname" id="exampleInputPassword1" placeholder="First Name" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Last Name*</label>
    <input type="text" class="form-control"  name="teacher_lname" id="exampleInputPassword1" placeholder="Last Name" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  name="teacher_mobile" id="exampleInputPassword1" placeholder="Mobile Number" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Subject</label>
    <input type="text" class="form-control"  name="teacher_subject" id="exampleInputPassword1" placeholder="Subject Name" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Photo</label>
    <input type="file" class="form-control"  name="tphoto" id="exampleInputPassword1"  required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Address</label>
    <input type="text" class="form-control"  name="teacher_address" id="exampleInputPassword1" placeholder="address" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Password</label>
    <input type="text" class="form-control"  name="teacher_password" id="exampleInputPassword1" placeholder="Password" required>
  </div>

  <input type="submit" class="btn btn-primary" value="Add">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="teacher_info"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
