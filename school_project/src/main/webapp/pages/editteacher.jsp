								...
								<form action="addTeacher" method="post">
									<div class="form-group">
										<label for="exampleInputPassword1">First Name*</label> <input
											type="hidden" class="form-control" name="teacher_id"
											value="${T.teacher_id}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">First Name*</label> <input
											type="text" class="form-control" name="teacher_fname"
											value="${T.teacher_fname}" id="exampleInputPassword1"
											placeholder="First Name" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Last Name*</label> <input
											type="text" class="form-control" name="teacher_lname"
											value="${T.teacher_lname}" id="exampleInputPassword1"
											placeholder="Last Name" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Email ID</label> <input
											type="text" class="form-control" name="email"
											value="${T.email}" id="exampleInputPassword1"
											placeholder="Mobile Number" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Mobile Number*</label> <input
											type="text" class="form-control" name="teacher_mobile"
											value="${T.teacher_mobile}" id="exampleInputPassword1"
											placeholder="Mobile Number" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Subject</label> <input
											type="text" class="form-control" name="teacher_subject"
											value="${T.teacher_subject}" id="exampleInputPassword1"
											placeholder="Mobile Number" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Photo</label> <input
											type="text" class="form-control" name="teacher_photo"
											value="${T.teacher_photo}" id="exampleInputPassword1"
											placeholder="photo" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Address</label> <input
											type="text" class="form-control" name="teacher_address"
											value="${T.teacher_address}" id="exampleInputPassword1"
											placeholder="address" required>
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Password</label> <input
											type="text" class="form-control" name="teacher_password"
											value="${T.teacher_password}" id="exampleInputPassword1"
											placeholder="Mobile Number" required>
									</div>

									<input type="submit" class="btn btn-primary" value="Update">
									<a href="" style="color: white;" class="btn btn-primary">Reset</a>
									<a href="teacher_info" style="color: white;"
