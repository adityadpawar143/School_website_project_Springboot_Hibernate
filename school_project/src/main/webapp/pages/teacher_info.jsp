					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="javascript:void(0)">Teacher info</a></li>
						</ol>
					</div>
				</div>
				<!-- row -->
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="col-sm-0 p-md-0 justify-content-sm-end">
									<a href="add_teacher" class="btn btn-primary"
										style="color: white;">+ Add new teacher</a>
								</div>
							</div>
									...
									<table id="example" class="display" style="min-width: 845px">
										...
										<c:forEach var="t" items="${t}">
											<tbody>
												<tr>
													<td>${t.teacher_id}</td>
													<td>${t.teacher_fname} ${t.teacher_lname}</td>
													<td>${t.email}</td>
													<td>${t.teacher_mobile}</td>
													<td>${t.teacher_subject}</td>
													<td>${t.teacher_photo}</td>
													<td>${t.teacher_address}</td>
													<td>${t.teacher_password}</td>
													<td><a href="editteacher?id=${t.teacher_id}"
														class="btn btn-primary">Edit</a> <a
														href="deleteteacher?id=${t.teacher_id}"
