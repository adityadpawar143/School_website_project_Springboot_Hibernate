...
<body>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" name="" id="exampleInputEmail1"  aria-describedby="emailHelp" >
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Batch Name*</label>
    <input type="text" class="form-control" name="batch_name" id="exampleInputPassword1" placeholder="Board Name" required>
  </div><br>
