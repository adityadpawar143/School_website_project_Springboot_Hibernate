                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-sm-0 p-md-0 justify-content-sm-end"><a href="teacher_add_video"  class="btn btn-primary" style="color:white;">+ Add new video</a></div>
                            </div>
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="teacher_editvideo?id=${v.vid}" class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                <a href="teacher_deletevideo?id=${v.vid}" class="btn btn-danger">Delete</a>
                                                </td>
