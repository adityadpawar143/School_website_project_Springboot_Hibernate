								...
								<form action="addStudent" method="post">
									<div>
										...
										<input type="hidden" class="form-control" name="student_id"
											value="${S.student_id}" id="exampleInputPassword1"
											placeholder="">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">First Name*</label> <input
											type="text" class="form-control" name="student_fname"
											value="${S.student_fname}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Last Name*</label> <input
											type="text" class="form-control" name="student_lname"
											value="${S.student_lname}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Email ID</label> <input
											type="text" class="form-control" name="email"
											value="${S.email}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Mobile Number*</label> <input
											type="text" class="form-control" name="student_mobile"
											value="${S.student_mobile}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Class Name</label> <input
											type="text" class="form-control" name="student_class"
											value="${S.student_class}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Batch Name</label> <input
											type="text" class="form-control" name="student_batch"
											value="${S.student_batch}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Board Name</label> <input
											type="text" class="form-control" name="student_board"
											value="${S.student_board}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Photo</label> <input
											type="text" class="form-control" name="student_photo"
											value="${S.student_photo}" id="exampleInputPassword1">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Password</label> <input
											type="text" class="form-control" name="student_password"
											value="${S.student_password}" id="exampleInputPassword1">
									</div>

									<input type="submit" class="btn btn-primary" value="Update">
									<a href="" style="color: white;" class="btn btn-primary">Reset</a>
									<a href="student_info" style="color: white;"
