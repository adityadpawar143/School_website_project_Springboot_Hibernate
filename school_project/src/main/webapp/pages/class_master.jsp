                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-sm-0 p-md-0 justify-content-sm-end"><a href="add_class_master"  class="btn btn-primary" style="color:white;">+ Add new class</a></div>
                            </div>
                                       ...
                                       <c:forEach var="c" items="${b}"> 
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>${c.class_name}</td>
                                                <td>
                                                <a href="editclass?id=${c.class_id}" class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                <a href="deleteclass?id=${c.class_id}" class="btn btn-danger">Delete</a>
                                                </td>
