...
<body>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="exampleInputEmail1" value="${S.subject_id}" name="subject_id"  aria-describedby="emailHelp" >
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Subject Name*</label>
    <input type="text" class="form-control" id="exampleInputPassword1" value="${S.subject_name}" name="subject_name" placeholder="Subject Name" required>
  </div><br>

  <input type="submit" class="btn btn-primary" value="Add">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="subject_master"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
