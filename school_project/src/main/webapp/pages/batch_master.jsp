                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-sm-0 p-md-0 justify-content-sm-end"><a href="add_batch_master"  class="btn btn-primary" style="color:white;">+ Add new Batch</a></div>
                            </div>
                                   ...
                                   <c:forEach var="batch" items="${b}"> 
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="editbatch?id=${batch.batch_id}"  class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                <a href="deletebatch?id=${batch.batch_id}" class="btn btn-danger">Delete</a>
                                                </td>
