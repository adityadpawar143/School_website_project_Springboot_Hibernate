...
<body>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="exampleInputEmail1" name="" aria-describedby="emailHelp" required>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Class Name*</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="class_name" placeholder="Class Name" required>
  </div><br>
