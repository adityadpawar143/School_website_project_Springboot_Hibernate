...
<body>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" value="${BB.batch_id}" name="batch_id" id="exampleInputEmail1"  aria-describedby="emailHelp" >
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Batch Name*</label>
    <input type="text" class="form-control" value="${BB.batch_name}" name="batch_name" id="exampleInputPassword1" placeholder="Board Name" required>
  </div><br>

  <input type="submit" class="btn btn-primary" value="Update">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="batch_master"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
