				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="teacher_addHomework" method="post">
									<div>

										<input type="hidden" class="form-control" name="hid"
											value="${H.hid}" id="exampleInputPassword1"
