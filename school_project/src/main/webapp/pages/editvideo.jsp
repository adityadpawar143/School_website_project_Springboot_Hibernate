...
<body>
  ...
  <div>
    ...
    <input type="hidden" class="form-control" name="vid" value="${V.vid}" id="exampleInputPassword1">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Board</label>
    <input type="text" class="form-control" name="video_board" value="${V.video_board}" id="exampleInputPassword1" placeholder="Board Name" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Class </label>
    <input type="text" class="form-control" name="video_class" value="${V.video_class}" id="exampleInputPassword1" placeholder="Class Name" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Batch</label>
    <input type="text" class="form-control" name="video_batch" value="${V.video_batch}" id="exampleInputPassword1" placeholder="Batch Name" required>
  </div>
   <div class="form-group">
    <label for="exampleInputPassword1">Subject</label>
    <input type="text" class="form-control" name="video_subject" value="${V.video_subject}" id="exampleInputPassword1" placeholder="Subject Name" required>
  </div>
   <div class="form-group">
    <label for="exampleInputPassword1">Teacher</label>
    <input type="text" class="form-control" name="teacher_name" value="${V.teacher_name}" id="exampleInputPassword1" placeholder="Teacher Name" required>
  </div>
 <div class="form-group">
    <label for="exampleInputPassword1">Youtube Link</label>
    <input type="text" class="form-control" name="video_link" value="${V.video_link}" id="exampleInputPassword1" placeholder="Youtube Link" required>
  </div>
	
  <input type="submit" class="btn btn-primary" value="Update">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="video_upload"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
