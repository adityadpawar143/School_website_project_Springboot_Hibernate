...
<body>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" id="exampleInputEmail1" value="${CC.class_id}" name="class_id" aria-describedby="emailHelp" required>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Class Name*</label>
    <input type="text" class="form-control" id="exampleInputPassword1" value="${CC.class_name}" name="class_name" placeholder="Class Name" required>
  </div><br>

  <input type="submit" class="btn btn-primary" value="Update">
   <a href="" style="color:white;" class="btn btn-primary">Reset</a>
    <a href="class_master"  style="color:white;" class="btn btn-primary">View Records</a>
</form>
                            </div>
                        </div>
                    </div>
