					...
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a
								href="javascript:void(0)">Homework info</a></li>
						</ol>
					</div>
				</div>
				<!-- row -->
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="col-sm-0 p-md-0 justify-content-sm-end">
									<a href="teacher_add_homework" class="btn btn-primary"
										style="color: white;">+ Add new homework</a>
								</div>
							</div>
										...
										<c:forEach var="h" items="${h}">
											<tbody>
												<tr>
													...
													<td>${h.homework_board}</td>
													<td>${h.homework_class}</td>
													<td>${h.homework_batch}</td>
													<td>${h.homework_subject}</td>

													<td><a href="" class="">${h.homework_link}</a></td>
													<td><a href="teacher_edithomework?id=${h.hid}"
														class="btn btn-primary">Edit</a></td>
													<td><a href="teacher_deletehomework?id=${h.hid}"
